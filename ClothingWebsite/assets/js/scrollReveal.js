...
var ScrollReveal = (function () {
    ...
    function u(e, t) {
        ...
        if (
            ...
            "object" == typeof window.NodeList
                ...
                : null !== n && "object" == typeof n && "number" == typeof n.length && /^\[object (HTMLCollection|NodeList|Object)\]$/.test(i) && (0 === n.length || o(n[0])))
        )
    ...
    function p(e) {
        ...
        if (E.generated || R.generated.initial) {
            ...
            E.generated && A.fragments.push({ delayed: "opacity " + L / 1e3 + "s " + M + " " + P / 1e3 + "s", instant: "opacity " + L / 1e3 + "s " + M + " 0s" }),
                R.generated.initial &&
                    A.fragments.push({ delayed: R.property + " " + L / 1e3 + "s " + M + " " + P / 1e3 + "s", instant: R.property + " " + L / 1e3 + "s " + M + " 0s" }),
    ...
    function w() {
        ...
        t.call(this),
            f(this.store.elements, function (e) {
                ...
                e.visible
                    ? (t.push(e.styles.opacity.computed), t.push(e.styles.transform.generated.final), (e.revealed = !0))
    ...
    return (
        (H.isSupported = function () {
            return (
                ("transform" in (t = document.documentElement.style) || "WebkitTransform" in t) && ("transition" in (e = document.documentElement.style) || "WebkitTransition" in e)
            );
            var e, t;
        }),
